...
export default function GiftHistoryPage() {
  const [gifts, setGifts] = useState([
    ...
    },
    {
      ...
      occasion: "Graduation",
      price: "$79.99",
      image: "/gifts/speaker.jpg",
    },
    {
      id: 10,
      name: "Yoga Mat",
      recipient: "Jennifer White",
      relationship: "Friend",
      date: "2023-07-07",
      occasion: "Birthday",
      price: "$42.00",
      image: "/gifts/yoga.jpg",
    },
    {
      id: 11,
      name: "Grilling Set",
    ...
    },
    {
      id: 12,
      name: "Baked Goods",
      recipient: "Susan Anderson",
      relationship: "Neighbor",
      date: "2023-09-03",
      occasion: "Thank You",
      price: "$18.75",
      image: "/gifts/baked.jpg",
    },
    {
      id: 13,
      name: "Photo Album",
      recipient: "Charles Martin",
      relationship: "Grandfather",
      date: "2023-10-30",
      occasion: "Birthday",
      price: "$29.99",
      image: "/gifts/album.jpg",
    },
  ]);
  ...
  const filteredGifts = gifts.filter((gift) => {
    ...
    const matchesOccasion =
      occasionFilter === "" || gift.occasion === occasionFilter;
    const matchesRecipient =
      recipientFilter === "" || gift.recipient === recipientFilter;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Card className="mb-8">
          <CardHeader className="pb-2">
            ...
            <CardDescription>
              Track all the gifts you've given to your loved ones
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            {filteredGifts.length > 0 && (
              <div className="flex items-center justify-between mt-6">
                <div className="text-sm text-gray-500">
                  Showing {indexOfFirstGift + 1} to{" "}
                  {Math.min(indexOfLastGift, filteredGifts.length)} of{" "}
